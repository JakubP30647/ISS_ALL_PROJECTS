...
MENU_PID_AND_FUZZY = {
    1: ("Start - jazda do przodu z sonarem", "iss4"),
    0: ("Powrót do menu głównego", "back")
...
def opis_komend():
    ...
    print(
        "╔════╦════════════════════════════╦════════════╦════════════════════════════════════════════════════════════════╗")
    print(
        "║ Nr ║ Komenda                    ║ W SYSTEMIE ║ Opis                                                           ║")
    print(
        "╠════╬════════════════════════════╬════════════╬════════════════════════════════════════════════════════════════╣")
    print(
        "║ 1. ║ Status robota              ║ 'status'   ║ Wyświetla aktualny stan robota (prędkość, kierunek, czujniki)  ║")
    print(
        "║ 2. ║ Zmień prędkość             ║ 'v'        ║ Umożliwia ustawienie nowej prędkości jazdy robota              ║")
    print(
        "║ 3. ║ Jazda do przodu            ║ 'przod'    ║ Uruchamia ruch robota do przodu                                ║")
    print(
        "║ 4. ║ Jazda do tyłu              ║ 'tyl'      ║ Uruchamia ruch robota do tyłu                                  ║")
    print(
        "║ 5. ║ Skręt w lewo               ║ 'lewo'     ║ Obraca robota w lewo                                           ║")
    print(
        "║ 6. ║ Skręt w prawo              ║ 'prawo'    ║ Obraca robota w prawo                                          ║")
    print(
        "║ 7. ║ STOP                       ║ 'stop'     ║ Natychmiast zatrzymuje robota                                  ║")
    print(
        "║ 8. ║ Odczyt sonaru (cm)         ║ 'b'        ║ Wyświetla pomiar z czujnika odległości (sonaru)                ║")
    print(
        "║ 9. ║ Odczyt czujnika IR         ║ 'i'        ║ Wyświetla dane z czujnika podczerwieni (IR)                    ║")
    print(
        "║10. ║ Powrót do menu głównego    ║ 'back'     ║ Powraca do głównego ekranu sterowania                          ║")
    print(
        "╚════╩════════════════════════════╩════════════╩════════════════════════════════════════════════════════════════╝")
